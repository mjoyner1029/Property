#!/usr/bin/env python3
"""
Simple script to create test users using the test framework approach.
This bypasses the db.create_all() call and uses the existing database.
"""
...
def create_test_users():
    ...
    with app.app_context():
        # Don't call db.create_all() - use existing database
